...
ipcRenderer.on("display:compass", function(e, magnetic, deviation, devDir, corrected, variation, varDir, gyro, comErr, errDir) {
  var inner = "<li class='collection-item'>Compass:<span class='right'>" + magnetic.toFixed(1) + "&deg;</span></li>"
  ...
  inner += "<li class='collection-item'>True:<span class='right'>" + gyro.toFixed(1) + "&deg;</span></li>"
...
ipcRenderer.on("display:gyro", function(e, gyro, latitude, latDir, LHA, declination, declDir, a, aDir, b, bDir, c, cDir, a3, az, azDir, gyroErr, errDir) {
  ...
  inner += "<li class='collection-item'>Azimuth:<span class='right'>" + cDir + "&deg; " + a3.toFixed(1) + " " + azDir + "</span</li>"
